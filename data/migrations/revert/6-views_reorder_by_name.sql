-- Revert zef-battles:6-views_reorder_by_name from pg

BEGIN;

DROP VIEW "character_with_capacity" CASCADE;

-- Recreate character_with_capacity view without the order by name
...
-- Recreate family_with_character view deleted when character_with_capacity view has been dropped
